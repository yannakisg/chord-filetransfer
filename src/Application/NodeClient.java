...
public class NodeClient {
    ...
    public static void main(String[] argv) throws IOException, InterruptedException {
        ...
        thisNode.setMainFrame(mainFrame);
        ...
        try {
            ...
            thisNode.getMainframe().sTitle(true);
        ...
        while (true) {
            ...
            text = "<b><font color=\"red\">Id: </font></b>" + "<font color=\"blue\">"+thisNode.getLocalID().hashKeytoHexString() + "</font><br>";
            Log.addMessage("IdKey : " + thisNode.getLocalID().hashKeytoHexString(), Log.INFORMATION);
            IdKey id;
            text += "<b><font color=\"red\">Successor: </font></b><font color=\"blue\">";
            ...
            if (thisNode.getSucListSize() > 0) {
                ...
                if (id == null) {
                    ...
                    text += id.hashKeytoHexString();
                }
            }
            text += "</font><br><b><font color=\"red\">Predecessor: </font></b><font color=\"blue\">";
